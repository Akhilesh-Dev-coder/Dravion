...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signinRes?.error) {
        setError("Account created, but autologin failed. Please sign in manually.");
        router.push("/login");
      } else {
        router.refresh();
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2 text-sm">
            Create your free account and launch your digital business card in minutes.
          </p>
        </div>
        ...
        <div className="glass-panel-premium p-8 rounded-2xl">
          <h1 className="text-xl font-semibold text-white mb-6 flex items-center">
            <UserPlus className="w-5 h-5 mr-2 text-primary" /> Create Account
          </h1>
          ...
          <div className="relative my-6 text-center">
            ...
            <span className="relative bg-[#0c101c] px-3 text-xs text-gray-500 font-medium">Or sign up with</span>
          </div>
